...
rally-assignment now uses hardhat-deploy to manage deployments, see the /deploy folder
...
const main = async () => {
  ...
  const RallyAssignment = await deploy("RallyAssignment"); // <-- add in constructor args like line 19 vvvv
  ...
  */
  ...
  // If you want to verify your contract on tenderly.co (see setup details in the rally-assignment README!)
  /*
  await tenderlyVerify(
    {contractName: "RallyAssignment",
     contractAddress: RallyAssignment.address
  })
  */
